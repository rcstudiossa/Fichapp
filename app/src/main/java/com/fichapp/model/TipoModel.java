...
public class TipoModel implements Serializable {
    ...
    public List<TipoModel> getComboEtnia() {

        List<TipoModel> combo = new ArrayList<>();

        combo.add(new TipoModel(null, "Não respondido"));
        combo.add(new TipoModel(1,"ACONA (WAKONAS, NACONAS, JAKONA, ACORANES)"));
        combo.add(new TipoModel(2,"AIKANA (AIKANA, MAS SAKA,TUBARAO)"));
        combo.add(new TipoModel(3,"AJURU"));
        combo.add(new TipoModel(4,"AKUNSU (AKUNT''SU)"));
        combo.add(new TipoModel(5,"AMANAYE"));
        combo.add(new TipoModel(6,"AMONDAWA"));
        combo.add(new TipoModel(7,"ANAMBE"));
        combo.add(new TipoModel(8,"APARAI (APALAI)"));
        combo.add(new TipoModel(9,"APIAKA (APIACA)"));
        combo.add(new TipoModel(10,"APINAYE (APINAJE/APINAIE/APINAGE)"));
        combo.add(new TipoModel(11,"APURINA (APORINA, IPURINA, IPURINA, IPURINAN)"));
        combo.add(new TipoModel(12,"ARANA (ARACUAI DO VALE DO JEQUITINHONHA)"));
        combo.add(new TipoModel(13,"ARAPASO (ARAPACO)"));
        combo.add(new TipoModel(14,"ARARA DE RONDONIA (KARO, URUCU, URUKU)"));
        combo.add(new TipoModel(15,"ARARA DO ACRE (SHAWANAUA, AMAWAKA)"));
        combo.add(new TipoModel(16,"ARARA DO ARIPUANA (ARARA DO BEIRADAO/ARI-PUANA)"));
        combo.add(new TipoModel(17,"ARARA DO PARA (UKARAGMA, UKARAMMA)"));
        combo.add(new TipoModel(18,"ARAWETE (ARAUETE)"));
        combo.add(new TipoModel(19,"ARIKAPU (ARICAPU, ARIKAPO, MASUBI, MAXUBI)"));
        combo.add(new TipoModel(20,"ARIKEM (ARIQUEN, ARIQUEME, ARIKEME)"));
        combo.add(new TipoModel(21,"ARIKOSE (ARICOBE)"));
        combo.add(new TipoModel(22,"ARUA"));
        combo.add(new TipoModel(23,"ARUAK (ARAWAK)"));
        combo.add(new TipoModel(24,"ASHANINKA (KAMPA)"));
        combo.add(new TipoModel(25,"ASURINI DO TOCANTINS (AKUAWA/AKWAWA)"));
        combo.add(new TipoModel(26,"ASURINI DO XINGU (AWAETE)"));
        combo.add(new TipoModel(27,"ATIKUM (ATICUM)"));
        combo.add(new TipoModel(28,"AVA - CANOEIRO"));
        combo.add(new TipoModel(29,"AWETI (AUETI/AUETO)"));
        combo.add(new TipoModel(30,"BAKAIRI (KURA, BACAIRI)"));
        combo.add(new TipoModel(31,"BANAWA YAFI (BANAWA, BANAWA-JAFI)"));
        combo.add(new TipoModel(32,"BANIWA (BANIUA, BANIVA, WALIMANAI, WAKUENAI)"));
        combo.add(new TipoModel(33,"BARA (WAIPINOMAKA)"));
        combo.add(new TipoModel(34,"BARASANA (HANERA)"));
        combo.add(new TipoModel(35,"BARE"));
        combo.add(new TipoModel(36,"BORORO (BOE)"));
        combo.add(new TipoModel(37,"BOTOCUDO (GEREN)"));
        combo.add(new TipoModel(38,"CANOE"));
        combo.add(new TipoModel(39,"CASSUPA"));
        combo.add(new TipoModel(40,"CHAMACOCO"));
        combo.add(new TipoModel(41,"CHIQUITANO (XIQUITANO)"));
        combo.add(new TipoModel(42,"CIKIYANA (SIKIANA)"));
        combo.add(new TipoModel(43,"CINTA LARGA (MATETAMAE)"));
        combo.add(new TipoModel(44,"COLUMBIARA (CORUMBIARA)"));
        combo.add(new TipoModel(45,"DENI"));
        combo.add(new TipoModel(46,"DESANA (DESANA, DESANO, DESSANO, WIRA, UMUKOMASA)"));
        combo.add(new TipoModel(47,"DIAHUI (JAHOI, JAHUI, DIARROI)"));
        combo.add(new TipoModel(48,"ENAWENE-NAWE (SALUMA)"));
        combo.add(new TipoModel(49,"FULNI-O"));
        combo.add(new TipoModel(50,"GALIBI (GALIBI DO OIAPOQUE, KARINHA)"));
        combo.add(new TipoModel(51,"GALIBI MARWORNO (GALIBI DO UACA, ARUA)"));
        combo.add(new TipoModel(52,"GAVIAO DE RONDONIA (DIGUT)"));
        combo.add(new TipoModel(53,"GAVIAO KRIKATEJE"));
        combo.add(new TipoModel(54,"GAVIAO PARKATEJE (PARKATEJE)"));
        combo.add(new TipoModel(55,"GAVIAO PUKOBIE (PUKOBIE, PYKOPJE, GAVIAO DO MARANHAO)"));
        combo.add(new TipoModel(56,"GUAJA (AWA, AVA)"));
        combo.add(new TipoModel(57,"GUAJAJARA (TENETEHARA)"));
        combo.add(new TipoModel(58,"GUARANI KAIOWA (PAI TAVYTERA)"));
        combo.add(new TipoModel(59,"GUARANI M''BYA"));
        combo.add(new TipoModel(60,"GUARANI NANDEVA (AVAKATUETE, CHIRIPA,NHANDEWA, AVA GUARANI)"));
        combo.add(new TipoModel(61,"GUATO"));
        combo.add(new TipoModel(62,"HIMARIMA (HIMERIMA)"));
        combo.add(new TipoModel(63,"INGARIKO (INGARICO, AKAWAIO, KAPON)"));
        combo.add(new TipoModel(64,"IRANXE (IRANTXE)"));
        combo.add(new TipoModel(65,"ISSE"));
        combo.add(new TipoModel(66,"JABOTI (JABUTI, KIPIU, YABYTI)"));
        combo.add(new TipoModel(67,"JAMAMADI (YAMAMADI, DJEOROMITXI)"));
        combo.add(new TipoModel(68,"JARAWARA"));
        combo.add(new TipoModel(69,"JIRIPANCO (JERIPANCO, GERIPANCO)"));
        combo.add(new TipoModel(70,"JUMA (YUMA)"));
        combo.add(new TipoModel(71,"JURUNA"));
        combo.add(new TipoModel(72,"JURUTI (YURITI)"));
        combo.add(new TipoModel(73,"KAAPOR (URUBU-KAAPOR, KA''APOR, KAAPORTE)"));
        combo.add(new TipoModel(74,"KADIWEU (CADUVEO, CADIUEU)"));
        combo.add(new TipoModel(75,"KAIABI (CAIABI, KAYABI)"));
        combo.add(new TipoModel(76,"KAIMBE (CAIMBE)"));
        combo.add(new TipoModel(77,"KAINGANG (CAINGANGUE)"));
        combo.add(new TipoModel(78,"KAIXANA (CAIXANA)"));
        combo.add(new TipoModel(79,"KALABASSA (CALABASSA, CALABACAS)"));
        combo.add(new TipoModel(80,"KALANCO"));
        combo.add(new TipoModel(81,"KALAPALO (CALAPALO)"));
        combo.add(new TipoModel(82,"KAMAYURA (CAMAIURA, KAMAIURA)"));
        combo.add(new TipoModel(83,"KAMBA (CAMBA)"));
        combo.add(new TipoModel(84,"KAMBEBA (CAMBEBA, OMAGUA)"));
        combo.add(new TipoModel(85,"KAMBIWA (CAMBIUA)"));
        combo.add(new TipoModel(86,"KAMBIWA PIPIPA (PIPIPA)"));
        combo.add(new TipoModel(87,"KAMPE"));
        combo.add(new TipoModel(88,"KANAMANTI (KANAMATI, CANAMANTI)"));
        combo.add(new TipoModel(89,"KANAMARI (CANAMARI, KANAMARY, TUKUNA)"));
        combo.add(new TipoModel(90,"KANELA APANIEKRA (CANELA)"));
        combo.add(new TipoModel(91,"KANELA RANKOKAMEKRA (CANELA)"));
        combo.add(new TipoModel(92,"KANINDE"));
        combo.add(new TipoModel(93,"KANOE (CANOE)"));
        combo.add(new TipoModel(94,"KANTARURE (CANTARURE)"));
        combo.add(new TipoModel(95,"KAPINAWA (CAPINAUA)"));
        combo.add(new TipoModel(96,"KARAJA (CARAJA)"));
        combo.add(new TipoModel(97,"KARAJA/JAVAE (JAVAE)"));
        combo.add(new TipoModel(98,"KARAJA/XAMBIOA (KARAJA DO NORTE)"));
        combo.add(new TipoModel(99,"KARAPANA (CARAPANA, MUTEAMASA, UKOPINOPONA)"));
        combo.add(new TipoModel(100,"KARAPOTO (CARAPOTO)"));
        combo.add(new TipoModel(101,"KARIPUNA (CARIPUNA)"));
        combo.add(new TipoModel(102,"KARIPUNA DO AMAPA (CARIPUNA)"));
        combo.add(new TipoModel(103,"KARIRI (CARIRI)"));
        combo.add(new TipoModel(104,"KARIRI-XOCO (CARIRI-CHOCO)"));
        combo.add(new TipoModel(105,"KARITIANA (CARITIANA)"));
        combo.add(new TipoModel(106,"KATAWIXI (KATAUIXI,KATAWIN, KATAWISI, CATAUICHI)"));
        combo.add(new TipoModel(107,"KATUENA (CATUENA, KATWENA)"));
        combo.add(new TipoModel(108,"KATUKINA (PEDA DJAPA)"));
        combo.add(new TipoModel(109,"KATUKINA DO ACRE"));
        combo.add(new TipoModel(110,"KAXARARI (CAXARARI)"));
        combo.add(new TipoModel(111,"KAXINAWA (HUNI-KUIN, CASHINAUA, CAXINAUA)"));
        combo.add(new TipoModel(112,"KAXIXO"));
        combo.add(new TipoModel(113,"KAXUYANA (CAXUIANA)"));
        combo.add(new TipoModel(114,"KAYAPO (CAIAPO)"));
        combo.add(new TipoModel(115,"KAYAPO KARARAO (KARARAO)"));
        combo.add(new TipoModel(116,"KAYAPO TXUKAHAMAE (TXUKAHAMAE)"));
        combo.add(new TipoModel(117,"KAYAPO XICRIM (XIKRIN)"));
        combo.add(new TipoModel(118,"KAYUISANA (CAIXANA, CAUIXANA, KAIXANA)"));
        combo.add(new TipoModel(119,"KINIKINAWA (GUAN, KOINUKOEN, KINIKINAO)"));
        combo.add(new TipoModel(120,"KIRIRI"));
        combo.add(new TipoModel(121,"KOCAMA (COCAMA, KOKAMA)"));
        combo.add(new TipoModel(122,"KOKUIREGATEJE"));
        combo.add(new TipoModel(123,"KORUBO"));
        combo.add(new TipoModel(124,"KRAHO (CRAO, KRAO)"));
        combo.add(new TipoModel(125,"KREJE (KRENYE)"));
        combo.add(new TipoModel(126,"KRENAK (BORUN, CRENAQUE)"));
        combo.add(new TipoModel(127,"KRIKATI (KRINKATI)"));
        combo.add(new TipoModel(128,"KUBEO (CUBEO, COBEWA, KUBEWA, PAMIWA, CUBEU)"));
        combo.add(new TipoModel(129,"KUIKURO (KUIKURU, CUICURO)"));
        combo.add(new TipoModel(130,"KUJUBIM (KUYUBI, CUJUBIM)"));
        combo.add(new TipoModel(131,"KULINA PANO (CULINA)"));
        combo.add(new TipoModel(132,"KULINA/MADIHA (CULINA, MADIJA, MADIHA)"));
        combo.add(new TipoModel(133,"KURIPAKO (CURIPACO, CURRIPACO, CORIPACO, WAKUENAI)"));
        combo.add(new TipoModel(134,"KURUAIA (CURUAIA)"));
        combo.add(new TipoModel(135,"KWAZA (COAIA, KOAIA)"));
        combo.add(new TipoModel(136,"MACHINERI (MANCHINERI, MANXINERI)"));
        combo.add(new TipoModel(137,"MACURAP (MAKURAP)"));
        combo.add(new TipoModel(138,"MAKU DOW (DOW)"));
        combo.add(new TipoModel(139,"MAKU HUPDA (HUPDA)"));
        combo.add(new TipoModel(140,"MAKU NADEB (NADEB)"));
        combo.add(new TipoModel(141,"MAKU YUHUPDE (YUHUPDE)"));
        combo.add(new TipoModel(142,"MAKUNA (MACUNA, YEBA-MASA)"));
        combo.add(new TipoModel(143,"MAKUXI (MACUXI, MACHUSI, PEMON)"));
        combo.add(new TipoModel(144,"MARIMAM (MARIMA)"));
        combo.add(new TipoModel(145,"MARUBO"));
        combo.add(new TipoModel(146,"MATIPU"));
        combo.add(new TipoModel(147,"MATIS"));
        combo.add(new TipoModel(148,"MATSE (MAYORUNA)"));
        combo.add(new TipoModel(149,"MAXAKALI (MAXACALI)"));
        combo.add(new TipoModel(150,"MAYA (MAYA)"));
        combo.add(new TipoModel(151,"MAYTAPU"));
        combo.add(new TipoModel(152,"MEHINAKO (MEINAKU, MEINACU)"));
        combo.add(new TipoModel(153,"MEKEN (MEQUEM, MEKHEM, MICHENS)"));
        combo.add(new TipoModel(154,"MENKY (MYKY, MUNKU, MENKI, MYNKY)"));
        combo.add(new TipoModel(155,"MIRANHA (MIRANHA, MIRANA)"));
        combo.add(new TipoModel(156,"MIRITI TAPUIA (MIRITI-TAPUYA, BUIA-TAPUYA)"));
        combo.add(new TipoModel(157,"MUNDURUKU (MUNDURUCU)"));
        combo.add(new TipoModel(158,"MURA"));
        combo.add(new TipoModel(159,"NAHUKWA (NAFUQUA)"));
        combo.add(new TipoModel(160,"NAMBIKWARA DO CAMPO (HALOTESU, KITHAULU, WAKALITESU, SAWENTES, MANDUKA)"));
        combo.add(new TipoModel(161,"NAMBIKWARA DO NORTE (NEGAROTE ,MAMAINDE, LATUNDE, SABANE E MANDUKA, TAWANDE)"));
        combo.add(new TipoModel(162,"NAMBIKWARA DO SUL (WASUSU ,HAHAINTESU, ALANTESU, WAIKISU, ALAKETESU, WASUSU, SARARE)"));
        combo.add(new TipoModel(163,"NARAVUTE (NARUVOTO)"));
        combo.add(new TipoModel(164,"NAWA (NAUA)"));
        combo.add(new TipoModel(165,"NUKINI (NUQUINI, NUKUINI)"));
        combo.add(new TipoModel(166,"OFAIE (OFAYE-XAVANTE)"));
        combo.add(new TipoModel(167,"ORO WIN"));
        combo.add(new TipoModel(168,"PAIAKU (JENIPAPO-KANINDE)"));
        combo.add(new TipoModel(169,"PAKAA NOVA (WARI, PACAAS NOVOS)"));
        combo.add(new TipoModel(170,"PALIKUR (AUKWAYENE, AUKUYENE, PALIKU''ENE)"));
        combo.add(new TipoModel(171,"PANARA (KRENHAKARORE , KRENAKORE, KRENA-KARORE)"));
        combo.add(new TipoModel(172,"PANKARARE (PANCARARE)"));
        combo.add(new TipoModel(173,"PANKARARU (PANCARARU)"));
        combo.add(new TipoModel(174,"PANKARARU KALANKO (KALANKO)"));
        combo.add(new TipoModel(175,"PANKARARU KARUAZU (KARUAZU)"));
        combo.add(new TipoModel(176,"PANKARU (PANCARU)"));
        combo.add(new TipoModel(177,"PARAKANA (PARACANA, APITEREWA, AWAETE)"));
        combo.add(new TipoModel(178,"PARECI (PARESI, HALITI)"));
        combo.add(new TipoModel(179,"PARINTINTIN"));
        combo.add(new TipoModel(180,"PATAMONA (KAPON)"));
        combo.add(new TipoModel(181,"PATAXO"));
        combo.add(new TipoModel(182,"PATAXO HA-HA-HAE"));
        combo.add(new TipoModel(183,"PAUMARI (PALMARI)"));
        combo.add(new TipoModel(184,"PAUMELENHO"));
        combo.add(new TipoModel(185,"PIRAHA (MURA PIRAHA)"));
        combo.add(new TipoModel(186,"PIRATUAPUIA (PIRATAPUYA, PIRATAPUYO, PIRA-TAPUYA, WAIKANA)"));
        combo.add(new TipoModel(187,"PITAGUARI"));
        combo.add(new TipoModel(188,"POTIGUARA"));
        combo.add(new TipoModel(189,"POYANAWA (POIANAUA)"));
        combo.add(new TipoModel(190,"RIKBAKTSA (CANOEIROS, ERIGPAKTSA)"));
        combo.add(new TipoModel(191,"SAKURABIAT(MEKENS, SAKIRABIAP, SAKIRABIAR)"));
        combo.add(new TipoModel(192,"SATERE-MAWE (SATERE-MAUE)"));
        combo.add(new TipoModel(193,"SHANENAWA (KATUKINA)"));
        combo.add(new TipoModel(194,"SIRIANO (SIRIA-MASA)"));
        combo.add(new TipoModel(195,"SURIANA"));
        combo.add(new TipoModel(196,"SURUI DE RONDONIA (PAITER)"));
        combo.add(new TipoModel(197,"SURUI DO PARA (AIKEWARA)"));
        combo.add(new TipoModel(198,"SUYA (SUIA/KISEDJE)"));
        combo.add(new TipoModel(199,"TAPAYUNA (BEICO-DE-PAU)"));
        combo.add(new TipoModel(200,"TAPEBA"));
        combo.add(new TipoModel(201,"TAPIRAPE (TAPI''IRAPE)"));
        combo.add(new TipoModel(202,"TAPUIA (TAPUIA-XAVANTE, TAPUIO)"));
        combo.add(new TipoModel(203,"TARIANO (TARIANA, TALIASERI)"));
        combo.add(new TipoModel(204,"TAUREPANG (TAULIPANG, PEMON, AREKUNA, PAGEYN)"));
        combo.add(new TipoModel(205,"TEMBE"));
        combo.add(new TipoModel(206,"TENHARIM"));
        combo.add(new TipoModel(207,"TERENA"));
        combo.add(new TipoModel(208,"TICUNA (TIKUNA, TUKUNA, MAGUTA)"));
        combo.add(new TipoModel(209,"TINGUI BOTO"));
        combo.add(new TipoModel(210,"TIRIYO EWARHUYANA (TIRIYO, TRIO, TARONA, YAWI, PIANOKOTO)"));
        combo.add(new TipoModel(211,"TIRIYO KAH''YANA (TIRIYO, TRIO, TARONA, YAWI, PIANOKOTO)"));
        combo.add(new TipoModel(212,"TIRIYO TSIKUYANA (TIRIYO, TRIO, TARONA, YAWI, PIANOKOTO)"));
        combo.add(new TipoModel(213,"TORA"));
        combo.add(new TipoModel(214,"TREMEMBE"));
        combo.add(new TipoModel(215,"TRUKA"));
        combo.add(new TipoModel(216,"TRUMAI"));
        combo.add(new TipoModel(217,"TSOHOM DJAPA (TSUNHUM-DJAPA)"));
        combo.add(new TipoModel(218,"TUKANO (TUCANO, YE''PA-MASA, DASEA)"));
        combo.add(new TipoModel(219,"TUMBALALA"));
        combo.add(new TipoModel(220,"TUNAYANA"));
        combo.add(new TipoModel(221,"TUPARI"));
        combo.add(new TipoModel(222,"TUPINAMBA"));
        combo.add(new TipoModel(223,"TUPINIQUIM"));
        combo.add(new TipoModel(224,"TURIWARA"));
        combo.add(new TipoModel(225,"TUXA"));
        combo.add(new TipoModel(226,"TUYUKA (TUIUCA, DOKAPUARA, UTAPINOMAKAPHONA)"));
        combo.add(new TipoModel(227,"TXIKAO (TXICAO, IKPENG)"));
        combo.add(new TipoModel(228,"UMUTINA (OMOTINA, BARBADOS)"));
        combo.add(new TipoModel(229,"URU-EU-WAU-WAU (URUEU-UAU-UAU, URUPAIN, URUPA)"));
        combo.add(new TipoModel(230,"WAI WAI HIXKARYANA (HIXKARYANA)"));
        combo.add(new TipoModel(231,"WAI WAI KARAFAWYANA (KARAFAWYANA, KARA-PAWYANA)"));
        combo.add(new TipoModel(232,"WAI WAI XEREU (XEREU)"));
        combo.add(new TipoModel(233,"WAI WAI KATUENA (KATUENA)"));
        combo.add(new TipoModel(234,"WAI WAI MAWAYANA (MAWAYANA)"));
        combo.add(new TipoModel(235,"WAIAPI (WAYAMPI, OYAMPI, WAYAPY, )"));
        combo.add(new TipoModel(236,"WAIMIRI ATROARI (KINA)"));
        combo.add(new TipoModel(237,"WANANO (UANANO, WANANA)"));
        combo.add(new TipoModel(238,"WAPIXANA (UAPIXANA, VAPIDIANA, WAPISIANA, WAPISHANA)"));
        combo.add(new TipoModel(239,"WAREKENA (UAREQUENA, WEREKENA)"));
        combo.add(new TipoModel(240,"WASSU"));
        combo.add(new TipoModel(241,"WAURA (UAURA, WAUJA)"));
        combo.add(new TipoModel(242,"WAYANA (WAIANA, UAIANA)"));
        combo.add(new TipoModel(243,"WITOTO (UITOTO, HUITOTO)"));
        combo.add(new TipoModel(244,"XAKRIABA (XACRIABA)"));
        combo.add(new TipoModel(245,"XAVANTE (A''UWE, AKWE, AWEN, AKWEN)"));
        combo.add(new TipoModel(246,"XERENTE (AKWE, AWEN, AKWEN)"));
        combo.add(new TipoModel(247,"XETA"));
        combo.add(new TipoModel(248,"XIPAIA (SHIPAYA, XIPAYA)"));
        combo.add(new TipoModel(249,"XOKLENG (SHOKLENG, XOCLENG)"));
        combo.add(new TipoModel(250,"XOKO (XOCO, CHOCO)"));
        combo.add(new TipoModel(251,"XUKURU (XUCURU)"));
        combo.add(new TipoModel(252,"XUKURU KARIRI (XUCURU-KARIRI)"));
        combo.add(new TipoModel(253,"YAIPIYANA"));
        combo.add(new TipoModel(254,"YAMINAWA (JAMINAWA, IAMINAWA)"));
        combo.add(new TipoModel(255,"YANOMAMI NINAM (IANOMAMI, IANOAMA, XIRIANA)"));
        combo.add(new TipoModel(256,"YANOMAMI SANUMA (IANOMAMI, IANOAMA, XIRIANA)"));
        combo.add(new TipoModel(257,"YANOMAMI YANOMAM (IANOMAMI, IANOAMA, XIRIANA)"));
        combo.add(new TipoModel(258,"YAWALAPITI (IAUALAPITI)"));
        combo.add(new TipoModel(259,"YAWANAWA (IAUANAUA)"));
        combo.add(new TipoModel(260,"YEKUANA (MAIONGON, YE''KUANA, YEKWANA, MAYONGONG)"));
        combo.add(new TipoModel(261,"YUDJA (JURUNA, YURUNA)"));
        combo.add(new TipoModel(262,"ZO''E (POTURU)"));
        combo.add(new TipoModel(263,"ZORO (PAGEYN)"));
        combo.add(new TipoModel(264,"ZURUAHA (SOROWAHA, SURUWAHA)"));
