...
public class TipoModel implements Serializable {
    ...
    public TipoModel(String codigo, String descricao) {
        this.codigo = codigo;
        this.descricao = descricao;
    }

    public TipoModel(String codigo) {
        this.codigo = codigo;
    }
    ...
    public List<TipoModel> getComboTipoImovel() {
        ...
        combo.add(new TipoModel("01", "Domicílio"));
        combo.add(new TipoModel("02", "Comércio"));
        combo.add(new TipoModel("03", "Terreno"));
        combo.add(new TipoModel("04", "Ponto"));
        combo.add(new TipoModel("05", "Escola"));
        combo.add(new TipoModel("06", "Creche"));
        combo.add(new TipoModel("07", "Abrigo"));
        combo.add(new TipoModel("08", "Instituição de longa permanência p/ idosos"));
        combo.add(new TipoModel("09", "Unidade prisional"));
    ...
    public List<TipoModel> getComboRendaFamiliar() {
        ...
        combo.add(new TipoModel(null, "Não respondido"));
        combo.add(new TipoModel("01", "1/4 sal. mínimo"));
        combo.add(new TipoModel("02", "1/2 sal. mínimo"));
        combo.add(new TipoModel("03", "01 sal. mínimo"));
        combo.add(new TipoModel("04", "02 sal. mínimos"));
        combo.add(new TipoModel("07", "03 sal. mínimos"));
        combo.add(new TipoModel("05", "04 sal. mínimos"));
        combo.add(new TipoModel("06", "Acima de 04 sal. mínimos"));
    ...
    public List<TipoModel> getComboRaca() {
        ...
        combo.add(new TipoModel(null, "Não respondido"));
        combo.add(new TipoModel("01", "Branca"));
        combo.add(new TipoModel("02", "Preta"));
        combo.add(new TipoModel("03", "Parda"));
        combo.add(new TipoModel("04", "Amarela"));
        combo.add(new TipoModel("05", "Indígena"));
        combo.add(new TipoModel("06", "Sem informação"));
    ...
    public List<TipoModel> getComboTrabalho() {
        ...
        combo.add(new TipoModel("71", "Autônomo sem previdência social"));
