...
public class FichaVisitaDTDbHelper extends SQLiteOpenHelper {
    ...
    public String getScriptCreateTable() {
        ...
        sb.append(" (id INTEGER PRIMARY KEY, profissional_id INTEGER, cnes_id INTEGER, ine VARCHAR, data_registro DATE, turno CHAR(1), microarea CHAR(2), tipo_imovel CHAR(2)");
        sb.append(", prontuario VARCHAR, cns_cidadao VARCHAR, data_nascimento date, sexo char(1), flag_visita_compartilhada boolean, flag_cadastramento  boolean, flag_visita_periodica boolean");
